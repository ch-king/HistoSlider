...
def paint_screenshot_image(
    ...
    scene.render(
        painter, QRectF(top_left, rendered_size), scene_rect, Qt.KeepAspectRatio
    )
...
def build_screenshot_image(
    scene: QGraphicsScene, image_size: QSize, scene_rect: QRectF = QRectF()
) -> QImage:
