...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpenSlide = QtWidgets.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/open.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionOpenSlide.setIcon(icon1)
        self.actionOpenSlide.setObjectName("actionOpenSlide")
        ...
        self.menuFile.addAction(self.actionOpenSlide)
        self.menuFile.addSeparator()
        self.menuFile.addAction(self.actionExit)
        self.menuHelp.addAction(self.actionAbout)
        self.menuBar.addAction(self.menuFile.menuAction())
        self.menuBar.addAction(self.menuHelp.menuAction())
        self.toolBar.addAction(self.actionOpenSlide)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpenSlide.setText(_translate("MainWindow", "Open Slide"))
        self.actionOpenSlide.setToolTip(_translate("MainWindow", "Open slide..."))
